...
urlpatterns = [
    ...
    path('chama/<int:chama_id>/restore/', views.chama_restore, name='chama_restore'),
    path('chama/<int:chama_id>/billing/pay/', views.chama_billing_pay, name='chama_billing_pay'),
    path('chama/<int:chama_id>/billing/poll/', views.chama_billing_poll, name='chama_billing_poll'),
