...
class Chama(models.Model):
    ...
    created_by          = models.ForeignKey(
        ...
        on_delete=models.SET_NULL, related_name='created_chamas'
    )
...
class Contribution(models.Model):
    ...
    recorded_by    = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True,
        on_delete=models.SET_NULL, related_name='recorded_contributions'
    )
    created_at     = models.DateTimeField(auto_now_add=True)
...
class Penalty(models.Model):
    ...
    member      = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='penalties'
    )
    amount      = models.DecimalField(max_digits=12, decimal_places=2)
    ...
    issued_by   = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True,
        on_delete=models.SET_NULL, related_name='issued_penalties'
    )
...
class LoanRepayment(models.Model):
    ...
    recorded_by    = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True,
        on_delete=models.SET_NULL, related_name='recorded_repayments'
    )
    created_at     = models.DateTimeField(auto_now_add=True)
...
class Transaction(models.Model):
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, null=True, blank=True,
        on_delete=models.SET_NULL, related_name='created_transactions'
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class MpesaTransaction(models.Model):
    ...
    member              = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='mpesa_transactions'
    )
    ...
    contribution        = models.OneToOneField(
        ...
        on_delete=models.SET_NULL, related_name='mpesa_tx'
    )
    loan_repayment      = models.OneToOneField(
        'LoanRepayment', null=True, blank=True,
        on_delete=models.SET_NULL, related_name='mpesa_tx'
    )
    created_at          = models.DateTimeField(auto_now_add=True)
